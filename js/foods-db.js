/* ============================================
   NutriPlan - Base de datos de alimentos comunes (v20260427uu)
   Usada por el modal "Comidas Externas" (estilo MyFitnessPal).
   Valores nutricionales por porciÃ³n estÃ¡ndar indicada.
   ============================================ */
(function() {
  window.FOODS_DB = [

    // â”€â”€ HUEVOS â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    ...
    // â”€â”€ LÃCTEOS â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    ...
    { id:'f_requesÃ³n',      nombre:'RequesÃ³n / ricotta',   nombre_en:'Ricotta',               porcion:'100g',              kcal:174, proteinas:11, carbohidratos:3,  grasas:13 },
    { id:'f_crema_agria',   nombre:'Crema agria',          nombre_en:'Sour cream',            porcion:'30g (2 cdas)',       kcal:60,  proteinas:1,  carbohidratos:1,  grasas:6  },

    // â”€â”€ PROTEÃNAS ANIMALES â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    ...
    { id:'f_salmon',        nombre:'SalmÃ³n',               nombre_en:'Salmon',                porcion:'100g',              kcal:206, proteinas:22, carbohidratos:0,  grasas:13 },
    { id:'f_atun',          nombre:'AtÃºn en agua',         nombre_en:'Canned tuna',           porcion:'1 lata (150g)',     kcal:160, proteinas:36, carbohidratos:0,  grasas:1  },
    ...
    { id:'f_jamon',         nombre:'JamÃ³n cocido',         nombre_en:'Cooked ham',            porcion:'50g (2 lÃ¡minas)',   kcal:75,  proteinas:10, carbohidratos:1,  grasas:3  },

    // â”€â”€ PROTEÃNAS VEGETALES â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    ...
    { id:'f_proteina',      nombre:'Batido de proteÃ­na',   nombre_en:'Protein shake',         porcion:'1 scoop (30g)',     kcal:120, proteinas:25, carbohidratos:5,  grasas:1  },

    // â”€â”€ CARBOHIDRATOS â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    ...
    { id:'f_tortilla',      nombre:'Tortilla de maÃ­z',     nombre_en:'Corn tortilla',         porcion:'1 unidad (30g)',    kcal:63,  proteinas:2,  carbohidratos:13, grasas:1  },

    // â”€â”€ VERDURAS â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    ...
    { id:'f_brocoli',       nombre:'BrÃ³coli',              nombre_en:'Broccoli',              porcion:'100g',              kcal:34,  proteinas:3,  carbohidratos:7,  grasas:0  },
    ...
    { id:'f_pimentÃ³n',      nombre:'PimentÃ³n',             nombre_en:'Bell pepper',           porcion:'100g',              kcal:31,  proteinas:1,  carbohidratos:6,  grasas:0  },
    ...
    { id:'f_champinones',   nombre:'ChampiÃ±ones',          nombre_en:'Mushrooms',             porcion:'100g',              kcal:22,  proteinas:3,  carbohidratos:3,  grasas:0  },
    ...
    // â”€â”€ FRUTAS â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    { id:'f_manzana',       nombre:'Manzana',              nombre_en:'Apple',                 porcion:'1 mediana (180g)', kcal:95,  proteinas:0,  carbohidratos:25, grasas:0  },
    { id:'f_platano',       nombre:'PlÃ¡tano',              nombre_en:'Banana',                porcion:'1 mediano (120g)', kcal:105, proteinas:1,  carbohidratos:27, grasas:0  },
    ...
    { id:'f_sandia',        nombre:'SandÃ­a',               nombre_en:'Watermelon',            porcion:'200g',              kcal:60,  proteinas:1,  carbohidratos:15, grasas:0  },
    { id:'f_arandanos',     nombre:'ArÃ¡ndanos',            nombre_en:'Blueberries',           porcion:'100g',              kcal:57,  proteinas:1,  carbohidratos:14, grasas:0  },
    ...
    { id:'f_melon',         nombre:'MelÃ³n',                nombre_en:'Melon',                 porcion:'200g',              kcal:68,  proteinas:2,  carbohidratos:16, grasas:0  },

    // â”€â”€ GRASAS SALUDABLES â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    { id:'f_almendras',     nombre:'Almendras',            nombre_en:'Almonds',               porcion:'30g (un puÃ±ado)',  kcal:175, proteinas:6,  carbohidratos:6,  grasas:15 },
    { id:'f_nueces',        nombre:'Nueces',               nombre_en:'Walnuts',               porcion:'30g',               kcal:196, proteinas:5,  carbohidratos:4,  grasas:19 },
    { id:'f_mani',          nombre:'ManÃ­',                 nombre_en:'Peanuts',               porcion:'30g',               kcal:170, proteinas:7,  carbohidratos:6,  grasas:15 },
    { id:'f_mantmani',      nombre:'Mantequilla de manÃ­',  nombre_en:'Peanut butter',         porcion:'30g (2 cdas)',      kcal:190, proteinas:8,  carbohidratos:7,  grasas:16 },
    ...
    { id:'f_chia',          nombre:'Semillas de chÃ­a',     nombre_en:'Chia seeds',            porcion:'15g (1 cda)',       kcal:73,  proteinas:2,  carbohidratos:6,  grasas:5  },
    ...
    // â”€â”€ COMIDAS PREPARADAS (contexto chileno) â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    ...
    { id:'f_cazuela',       nombre:'Cazuela',              nombre_en:'Chilean cazuela stew',  porcion:'1 porciÃ³n (400g)', kcal:320, proteinas:25, carbohidratos:28, grasas:8  },
    ...
    { id:'f_ensalada_ces',  nombre:'Ensalada CÃ©sar',       nombre_en:'Caesar salad',          porcion:'1 porciÃ³n (200g)', kcal:280, proteinas:8,  carbohidratos:12, grasas:22 },
    ...
    { id:'f_sandwich_jq',   nombre:'Sandwich jamÃ³n y queso',nombre_en:'Ham and cheese sandwich',porcion:'1 unidad',        kcal:350, proteinas:18, carbohidratos:35, grasas:14 },
    ...
    { id:'f_bowl_arroz',    nombre:'Bowl de arroz con proteÃ­na',nombre_en:'Protein rice bowl',porcion:'350g',              kcal:480, proteinas:35, carbohidratos:58, grasas:10 },

    // â”€â”€ COMIDAS CHILENAS ADICIONALES â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    { id:'f_charquican',    nombre:'CharquicÃ¡n',           nombre_en:'CharquicÃ¡n stew',       porcion:'300g',              kcal:290, proteinas:18, carbohidratos:35, grasas:8  },
    ...
    { id:'f_milhojas',      nombre:'Milhojas',             nombre_en:'Napoleon cake',         porcion:'1 porciÃ³n (100g)', kcal:380, proteinas:5,  carbohidratos:45, grasas:20 },
    ...
    // â”€â”€ PESCADOS CHILENOS â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    ...
    { id:'f_albacora',      nombre:'Albacora / AtÃºn fresco',nombre_en:'Albacore tuna',        porcion:'150g',              kcal:240, proteinas:33, carbohidratos:0,  grasas:12 },
    ...
    // â”€â”€ DESAYUNO â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    ...
    // â”€â”€ FAST FOOD â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    ...
    { id:'f_papas_mcd',     nombre:'Papas fritas McDonald\'s',nombre_en:'McDonald\'s fries',  porcion:'porciÃ³n mediana',   kcal:340, proteinas:4,  carbohidratos:44, grasas:16 },
    ...
    // â”€â”€ VERDURAS ADICIONALES â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    ...
    { id:'f_rucula',        nombre:'RÃºcula',               nombre_en:'Arugula',               porcion:'50g',               kcal:13,  proteinas:1,  carbohidratos:2,  grasas:0  },
    ...
    // â”€â”€ FRUTAS ADICIONALES â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    ...
    { id:'f_limÃ³n',         nombre:'LimÃ³n / Lima',         nombre_en:'Lemon / Lime',          porcion:'1 unidad (50g)',    kcal:15,  proteinas:0,  carbohidratos:5,  grasas:0  },
    { id:'f_piÃ±a',          nombre:'PiÃ±a',                 nombre_en:'Pineapple',             porcion:'150g',              kcal:75,  proteinas:1,  carbohidratos:20, grasas:0  },
    ...
    // â”€â”€ FRUTOS SECOS ADICIONALES â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    ...
    { id:'f_castanias',     nombre:'CastaÃ±as',             nombre_en:'Chestnuts',             porcion:'50g',               kcal:99,  proteinas:2,  carbohidratos:21, grasas:1  },
    ...
    // â”€â”€ LÃCTEOS ADICIONALES â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    { id:'f_helado',        nombre:'Helado',               nombre_en:'Ice cream',             porcion:'2 bolas (120g)',    kcal:250, proteinas:4,  carbohidratos:32, grasas:12 },
    { id:'f_queso_cheddar', nombre:'Queso cheddar / laminado',nombre_en:'Cheddar cheese',    porcion:'30g (2 lÃ¡minas)',   kcal:110, proteinas:7,  carbohidratos:0,  grasas:9  },
    ...
    // â”€â”€ GRANOS Y HARINAS â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    { id:'f_cuscus',        nombre:'CuscÃºs cocido',        nombre_en:'Cooked couscous',       porcion:'150g',              kcal:175, proteinas:6,  carbohidratos:36, grasas:0  },
    ...
    // â”€â”€ CONDIMENTOS Y ENDULZANTES â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    { id:'f_miel',          nombre:'Miel',                 nombre_en:'Honey',                 porcion:'15ml (1 cda)',      kcal:64,  proteinas:0,  carbohidratos:17, grasas:0  },
    { id:'f_azucar',        nombre:'AzÃºcar',               nombre_en:'Sugar',                 porcion:'10g (1 cdita)',     kcal:39,  proteinas:0,  carbohidratos:10, grasas:0  },
    ...
    // â”€â”€ BEBIDAS â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    ...
    // â”€â”€ SNACKS / EXTRAS â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
